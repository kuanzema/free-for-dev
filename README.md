...
## Generative AI
  ...
  * [HarnessRouter](https://harnessrouter.ai) - Unified API to run agent harnesses (Codex, Claude Code, Hermes) behind your product: tasks, sandboxed sessions, streaming, files, and reviewable artifacts. Building and integrating is free; credits are only consumed when tasks run.
